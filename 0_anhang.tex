...
% Grundlagen - Double-sided Two-way Ranging

\begin{figure}[h!]
	\centering
	\includegraphics[width=0.4\linewidth]{discovery_and_ranging_phase2}
	\captionwithcite{Der Ablauf der Discovery- und Range-Phase zwischen einem \glsentrytext{tag} und mehreren \glsentrytext{anchor}n.}{\cite{decawave2016dw1kusermanual}}
...
% Ultra-Wideband - Prototypen

\begin{figure}[h!]
  \centering
  \includegraphics[width=0.28\textwidth]{pcb_dwm1000_adapterboard_top}
  \caption{\glsentryshort{pcb}-Adapterboard für den DWM1000.}
  \label{fig:pcb_dwm1000_adapterboard_top}
\end{figure}

% Ultra-Wideband - Platinendesign

\begin{figure}[h!]
	\centering
	\includegraphics[width=\textwidth]{dwm1000_antenna_radiation_pattern}
	\captionwithcite{Das Antennenabstrahlmuster in horizontaler Richtung.}{\cite{decawave2016dwm1kdatasheet}}
	\label{fig:dwm1000_antenna_radiation_pattern}
\end{figure}
	
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\textwidth]{dwm1000_application_board_keep_out_areas}
	\captionwithcite{Antennenfreiräume}{\cite{decawave2016dwm1kdatasheet}}
...
% Ultra-Wideband - Mikrocontroller
...
% Ultra-Wideband - Energieversorgung
...
% Ultra-Wideband - Materialkosten pro UWB-Modul
...
\hline
	\end{tabular}
	\caption{Stochastische Merkmale der \glsentryshort{nlos}--Entfernungsmessung mit einem Aluminiumblech in einer Entfernung von \SI{5}{\centi\meter}.}
