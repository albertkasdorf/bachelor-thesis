...
\footnotetext{Der Adafruit Pro Trinket \SI{3.3}{\volt} ist zum Großteil pinkompatibel zu der \SI{5}{\volt} Variante. Nur der Pin BAT+ benötigte eine Batteriespannung von \SIrange{3.5}{16}{\volt} und der drei Reihen weiter unten liegende \SI{5}{\volt} Pin liefert nur \SI{3.3}{\volt}.}
...
Um den Lithium-Ionen Akku zu laden, bedarf es nicht mehr als den \Gls{usb} Stecker des Pro Trinket mit dem Computer oder einem \Gls{usb} Ladegerät zu verbinden.
...
Mittels der \Gls{ros} Nachricht ObservationRangeBeacon wird die Sensor-Charakteristik des \Glsuserii{uwbm} beschrieben. Hierzu gehören die minimal und maximal messbare Entfernung, das Sensorrauschen, eine oder mehrere Entfernungsmessungen und einige \Gls{ros} spezifische Angaben wie z.B. das Koordinatensystem in dem sich das \Gls{uwbm} befindet.
