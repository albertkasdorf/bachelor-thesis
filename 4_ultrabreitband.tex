...
------------------------------------------------------------------------------------------
\end{comment}
\subsubsection{Kosten pro Modul}

Die Kosten pro Modul sind in der \tablename~\ref{tab:kosten_pro_modul} zu finden. Die Bauelemente die jeweils für einen Tag bzw. Anker benötigt werden sind in der dazugehörigen Spalte angekreuzt.

\begin{sidewaystable}
	\centering
	\begin{tabular}{||c|c|l|c|l|c|r||} 
		\hline
		Tag & Anker & Anbieter & Artikelnummer & Komponente & Anzahl & Stückpreis\\\hline
		\hline
		...
		\Square & \CheckedBox & Conrad & 251007-62 & Emmerich LiIon Akku ICR-18650 NH-SP mit Kabel & 1 & \SI{9.99}{\euro}\\\hline
		\hline
		...
		\hline
		\multicolumn{6}{|r|}{Gesamtpreis für einen Tag:} & \SI{45.15}{\euro}\\\hline
		\multicolumn{6}{|r|}{Gesamtpreis für einen Anker:} & \SI{56.24}{\euro}\\\hline
	\end{tabular}
	\caption{Kosten pro Tag bzw. Anker.}
