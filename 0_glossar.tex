...
% z.B. name=Modul; pluarl=Module; user1=Modulen
...
{
	% https://en.wikipedia.org/wiki/Electric_beacon#Radio_beacons
	% https://de.wikipedia.org/wiki/Funkbake;
	% http://www.spektrum.de/news/wo-bitte-gehts-zur-intelligenten-navigation/1410559
...
} % Wikipedia: Footprint (engl. Fußabdruck, Fußspur) die Umrisse von Lötflächen von elektrischen Bauelementen auf einer Leiterplatte.
...
\newglossaryentry{pf}
{
	name={Partikel Filter}, sort={Partikel Filter}, user2={Partikel Filters},
	description={},
}
...
\newacronym{rf2o}{RF2O}{Range Flow-based 2D Odometry}

\newglossaryentry{rosm}
{
	name={ROS Modul}, sort={ROS Modul}, plural={ROS Module}, user1={ROS Modulen},
	description={}
}
...
\newacronym{sog}{SOG}{Sum of Gaussians}
