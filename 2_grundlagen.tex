...
\begin{figure}
	...
	\captionwithcite{Ablauf des \glsentrylong{sstwr} Verfahrens.}{\cite{decawave2016dw1kusermanual}}
...
%	\includegraphics[width=0.7\linewidth]{double_sided_two_way_ranging}
	...
	\captionwithcite{Ablauf des \glsentrylong{dstwr} Verfahrens.}{\cite{decawave2016dw1kusermanual}} 
...
\begin{figure}
	...
	\captionwithcite{Ablauf des \glsentrylong{dstwr} Verfahren mit einem \glsentrytext{tag} und drei \glsentrytext{anchor}n.}{\cite{decawave2016dw1kusermanual}}
...
Bei dem FastSLAM Verfahren handelt es sich um eine Lösung für das \gls{slam} Problem mithilfe eines \glsuserii{pf}. Bei einem \gls{pf} repräsentiert jedes Partikel eine eigene Hypothese  des jeweiligen Zustandes des Roboters. Um das \gls{slam} Problem zu lösen muss der Zustandsvektor, wie beim EKF-SLAM, um die Landmarken erweitert werden, siehe \autoref{eq:ekf_slam_state_vector}.
